...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::firstOrCreate(['name'=> 'drive.index'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive.create'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive.store'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive.edit'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive.update'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive.destroy'])->syncRoles([$super_admin, $admin]);
        
        Permission::firstOrCreate(['name'=> 'drive_type.index'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive_type.create'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive_type.store'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive_type.edit'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive_type.update'])->syncRoles([$super_admin, $admin]);
        Permission::firstOrCreate(['name'=> 'drive_type.destroy'])->syncRoles([$super_admin, $admin]);
